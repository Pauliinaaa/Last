 ...
 */
final class Version20220405130625 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipes DROP category_id, CHANGE name name VARCHAR(120) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE content content VARCHAR(1020) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
