 ...
 */
final class Version20220414131044 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD recipe_id INT NOT NULL, CHANGE user_nick user_nick VARCHAR(25) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE user_email user_email VARCHAR(128) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE content content VARCHAR(1020) NOT NULL COLLATE `utf8mb4_unicode_ci`');
